# This Makefile is for the Open::This extension to perl.
#
...
#     ABSTRACT => q[Try to Do the Right Thing when opening files]
#     AUTHOR => [q[Olaf Alders <olaf@wundercounter.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     DISTNAME => q[Open-This]
#     EXE_FILES => [q[script/ot]]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.012000]
#     NAME => q[Open::This]
#     PREREQ_PM => { Browser::Open=>q[0], Carp::Always=>q[0], Cpanel::JSON::XS=>q[0], ExtUtils::MakeMaker=>q[0], File::Spec=>q[0], Getopt::Long=>q[0], Module::Runtime=>q[0], Module::Util=>q[0.016], Path::Tiny=>q[0], Pod::Usage=>q[0], Test::Differences=>q[0], Test::Fatal=>q[0], Test::More=>q[0], Test::Needs=>q[0], Test::Requires::Git=>q[0], Test::Script=>q[1.29], Test::Simple=>q[1.302177], Test::Warnings=>q[0], Try::Tiny=>q[0], URI=>q[0], lib=>q[0], strict=>q[0], warnings=>q[0] }
#     TEST_REQUIRES => { Carp::Always=>q[0], ExtUtils::MakeMaker=>q[0], File::Spec=>q[0], Test::Differences=>q[0], Test::Fatal=>q[0], Test::More=>q[0], Test::Needs=>q[0], Test::Requires::Git=>q[0], Test::Script=>q[1.29], Test::Simple=>q[1.302177], Test::Warnings=>q[0], lib=>q[0] }
#     VERSION => q[0.000035]
#     test => { TESTS=>q[t/*.t] }
...
H_FILES  = 
MAN1PODS = script/ot
MAN3PODS = lib/Open/This.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Open
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Open
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN1EXT) --perm_rw=$(PERM_RW) -u \
	  script/ot $(INST_MAN1DIR)/ot.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Open/This.pm $(INST_MAN3DIR)/Open::This.$(MAN3EXT) 
...
$(INST_SCRIPT)/ot : script/ot $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/ot
	$(CP) script/ot $(INST_SCRIPT)/ot
	$(FIXIN) $(INST_SCRIPT)/ot
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/ot
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Try to Do the Right Thing when opening files'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Test::Requires::Git: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::Script: '\''1.29'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::Simple: '\''1.302177'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Open-This' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Module::Util: '\''0.016'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: '\''0.000035'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'x_serialization_backend: '\''CPAN::Meta::YAML version 0.018'\''' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "Try to Do the Right Thing when opening files",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Open-This",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Module::Util" : "0.016",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Carp::Always" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::MakeMaker" : "0",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Test::Requires::Git" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::Script" : "1.29",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::Simple" : "1.302177",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.000035",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Open-This" VERSION="0.000035">' > Open-This.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Try to Do the Right Thing when opening files</ABSTRACT>' >> Open-This.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Olaf Alders &lt;olaf@wundercounter.com&gt;</AUTHOR>' >> Open-This.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,012000,0,0" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Browser::Open" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Cpanel::JSON::XS" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Getopt::Long" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Module::Runtime" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Module::Util" VERSION="0.016" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Path::Tiny" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Usage" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Try::Tiny" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="URI::" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="strict::" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="warnings::" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.38" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Open-This.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Open-This.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Open-This.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Open/This.pm' 'blib/lib/Open/This.pm' 
